...
void params_translate_redec(const params_t* params_encoded, public_params_t* params_translated)
{
    ...
    REDC2(&temp, &modtemp, &params_translated->xQ2);
    fp2_zero(&temp);
    ...
    REDC2(&temp, &modtemp, &params_translated->xP2);
    fp2_zero(&temp);
    ...
    REDC2(&temp, &modtemp, &params_translated->xR2);
    fp2_zero(&temp);
    ...
    REDC2(&temp, &modtemp, &params_translated->xQ3);
    fp2_zero(&temp);
    ...
    REDC2(&temp, &modtemp, &params_translated->xP3);
    fp2_zero(&temp);
    ...
    REDC2(&temp, &modtemp, &params_translated->xR3);
    fp2_zero(&temp);
}
